...
class Background:
    ...
    def update(self, target):
        ...
        background.blit(cloudLayer, self._cloudCord)
    ...
    def moveL(self):
        ...
        if self._mountCord[0] > self._width + 10:
            self._mountCord = (-350, self._mountCord[1])
        if self._mountCord[0] < -350:
            self._mountCord = (self._width + 9, self._mountCord[1])
